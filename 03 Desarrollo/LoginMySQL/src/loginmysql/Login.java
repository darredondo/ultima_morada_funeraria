...
public class Login extends javax.swing.JFrame {
    ...
    public Connection Conectar() {
        Connection con = null;
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/miultimamorada","root","");
    ...
    public void ingresar() {
        ...
        if (User.equals("") || Pass.equals("")) {
            ...
            try {
                con1 = Conectar();
                pst = con1.prepareStatement("select Usuario, Contrasenna from usuario where Usuario='" + User
                        + "' and Contrasenna ='" + Pass + "'");
                rs = pst.executeQuery();
                if (rs.next()) {
                    this.dispose();
    ...
    private void initComponents() {
        ...
        TITULO.setFont(new java.awt.Font("Kunstler Script", 1, 36)); // NOI18N
        TITULO.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        TITULO.setText("ULTIMA MORADA");
